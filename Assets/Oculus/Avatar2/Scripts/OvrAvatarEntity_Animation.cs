...
namespace Oculus.Avatar2
{
    ...
    public partial class OvrAvatarEntity
    {
        ...
        private abstract class EntityAnimatorBase
        {
                ...
                in CAPI.ovrAvatar2EntityRenderState renderState)
            {
                ...
                if (skeletalAnimation || morphAnimation)
                {
                    ...
                    var animatablePrimitives = Entity.GetPrimitivesWithAnimationEnabled();
        ...
        private List<PrimitiveRenderData> GetPrimitivesWithAnimationEnabled()
        {
        ...
        {
            OvrAvatarLog.Assert(!IsApplyingModels, logScope, this);
